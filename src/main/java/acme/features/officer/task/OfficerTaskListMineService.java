...
@Service
public class OfficerTaskListMineService implements AbstractListService<Officer,Task> {
	...
	public Collection<Task> findMany(final Request<Task> request) {
		...
		result = this.repository.findManyTasksByOfficerId(principal.getActiveRoleId());
