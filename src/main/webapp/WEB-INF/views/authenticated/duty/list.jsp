...
<acme:list>
		...
		<acme:list-column code="manager.duty.list.label.initialMoment" path="initialMoment" width="20%"/>
		<acme:list-column code="manager.duty.list.label.endMoment" path="endMoment" width="20%"/>
		<acme:list-column code="manager.duty.list.label.description" path="description" width="60%"/>	
</acme:list>
