...
public class OfficerTaskDeleteTest extends AcmeEndeavoursTest {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/officer/task/delete-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/officer/task/delete-negative.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(20)
